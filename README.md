...
The backend app is deployed (both the backend and the MySQL database) in a railway server for testing. Follow this swagger documentation to access the API documentation and try testing:

"https://hirelens-challenges-production.up.railway.app/api-docs/#/"

NOTES: challenges done and challenges pending: Done:
